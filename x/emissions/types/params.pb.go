...
type Params struct {
	...
	FallbackListeningCoefficient github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,52,opt,name=fallback_listening_coefficient,json=fallbackListeningCoefficient,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"fallback_listening_coefficient"`
	MinExperiencedWorkerRegrets  int64                                           `protobuf:"varint,53,opt,name=min_experienced_worker_regrets,json=minExperiencedWorkerRegrets,proto3" json:"min_experienced_worker_regrets,omitempty"`
}
...
func (m *Params) GetMinExperiencedWorkerRegrets() int64 {
	if m != nil {
...
var fileDescriptor_510cba56e74b19fc = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.FallbackListeningCoefficient.Size()
		i -= size
		if _, err := m.FallbackListeningCoefficient.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *Params) Size() (n int) {
	...
	l = m.FallbackListeningCoefficient.Size()
	n += 2 + l + sovParams(uint64(l))
	if m.MinExperiencedWorkerRegrets != 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 52:
			...
			if err := m.FallbackListeningCoefficient.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 53:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinExperiencedWorkerRegrets |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
