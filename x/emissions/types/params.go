...
func DefaultParams() Params {
	return Params{
		...
		GlobalAdminsEnabled:                 true,                                         // global admins enabled => the global admins whitelist determines which admins can create topics and participate in all topics as workers and reputers
