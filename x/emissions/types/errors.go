...
var (
	...
	ErrNotPermittedToUpdateWhitelistAdmins      = errors.Register(ModuleName, 28, "not permitted to update whitelist admins")
	...
	ErrNotPermittedToUpdateTopicWhitelist        = errors.Register(ModuleName, 81, "not permitted to update topic whitelist")
	ErrNotPermittedToCreateTopic                 = errors.Register(ModuleName, 82, "not permitted to create topic")
	ErrNotPermittedToSubmitWorkerPayload         = errors.Register(ModuleName, 83, "not permitted to submit worker payload")
	ErrNotPermittedToSubmitReputerPayload        = errors.Register(ModuleName, 84, "not permitted to submit reputer payload")
	ErrNotPermittedToUpdateParams                = errors.Register(ModuleName, 85, "not permitted to update params")
	ErrNotPermittedToUpdateGlobalWhitelist       = errors.Register(ModuleName, 86, "not permitted to update global whitelist")
