...
func (s *MsgServerTestSuite) TestUpdateAllParams() {
	...
	newParams := &types.OptionalParams{
		...
		NewParticipantScoreInitializationKappa: []alloraMath.Dec{alloraMath.MustNewDecFromString("1")},
	}
	...
	require.Equal(newParams.NewParticipantScoreInitializationKappa[0], updatedParams.NewParticipantScoreInitializationKappa)
}
