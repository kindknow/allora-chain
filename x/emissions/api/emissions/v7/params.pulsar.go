...
<<<<<<< HEAD
	fd_Params_lambda_initial_score                      protoreflect.FieldDescriptor
=======
	fd_Params_sortition_lambda_penalty                  protoreflect.FieldDescriptor
	fd_Params_global_worker_whitelist_enabled           protoreflect.FieldDescriptor
	fd_Params_global_reputer_whitelist_enabled          protoreflect.FieldDescriptor
	fd_Params_global_admins_enabled                     protoreflect.FieldDescriptor
	fd_Params_max_whitelist_input_array_length          protoreflect.FieldDescriptor
>>>>>>> 53d9684b (add global params)
)

func init() {
	file_emissions_v7_params_proto_init()
	md_Params = File_emissions_v7_params_proto.Messages().ByName("Params")
	...
	fd_Params_max_string_length = md_Params.Fields().ByName("max_string_length")
	fd_Params_initial_regret_quantile = md_Params.Fields().ByName("initial_regret_quantile")
	fd_Params_p_norm_safe_div = md_Params.Fields().ByName("p_norm_safe_div")
	fd_Params_global_whitelist_enabled = md_Params.Fields().ByName("global_whitelist_enabled")
	fd_Params_topic_creator_whitelist_enabled = md_Params.Fields().ByName("topic_creator_whitelist_enabled")
...
<<<<<<< HEAD
	fd_Params_lambda_initial_score = md_Params.Fields().ByName("lambda_initial_score")
=======
	fd_Params_sortition_lambda_penalty = md_Params.Fields().ByName("sortition_lambda_penalty")
	fd_Params_global_worker_whitelist_enabled = md_Params.Fields().ByName("global_worker_whitelist_enabled")
	fd_Params_global_reputer_whitelist_enabled = md_Params.Fields().ByName("global_reputer_whitelist_enabled")
	fd_Params_global_admins_enabled = md_Params.Fields().ByName("global_admins_enabled")
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v7_params_proto_msgTypes[0]
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MaxStringLength != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxStringLength)
		if !f(fd_Params_max_string_length, value) {
			return
		}
	}
	if x.InitialRegretQuantile != "" {
		value := protoreflect.ValueOfString(x.InitialRegretQuantile)
		if !f(fd_Params_initial_regret_quantile, value) {
			return
		}
	}
	if x.PNormSafeDiv != "" {
		value := protoreflect.ValueOfString(x.PNormSafeDiv)
		if !f(fd_Params_p_norm_safe_div, value) {
			return
		}
	}
	if x.GlobalWhitelistEnabled != false {
		value := protoreflect.ValueOfBool(x.GlobalWhitelistEnabled)
		if !f(fd_Params_global_whitelist_enabled, value) {
			return
		}
	}
	if x.TopicCreatorWhitelistEnabled != false {
		value := protoreflect.ValueOfBool(x.TopicCreatorWhitelistEnabled)
		if !f(fd_Params_topic_creator_whitelist_enabled, value) {
			return
		}
	}
	...
	if x.InferenceOutlierDetectionThreshold != "" {
		value := protoreflect.ValueOfString(x.InferenceOutlierDetectionThreshold)
		if !f(fd_Params_inference_outlier_detection_threshold, value) {
			return
		}
	}
	if x.InferenceOutlierDetectionAlpha != "" {
		value := protoreflect.ValueOfString(x.InferenceOutlierDetectionAlpha)
		if !f(fd_Params_inference_outlier_detection_alpha, value) {
			return
		}
	}
	if x.LambdaInitialScore != "" {
		value := protoreflect.ValueOfString(x.LambdaInitialScore)
		if !f(fd_Params_lambda_initial_score, value) {
			return
		}
	}
	if x.GlobalWorkerWhitelistEnabled != false {
		value := protoreflect.ValueOfBool(x.GlobalWorkerWhitelistEnabled)
		if !f(fd_Params_global_worker_whitelist_enabled, value) {
			return
		}
	}
	if x.GlobalReputerWhitelistEnabled != false {
		value := protoreflect.ValueOfBool(x.GlobalReputerWhitelistEnabled)
		if !f(fd_Params_global_reputer_whitelist_enabled, value) {
			return
		}
	}
	if x.GlobalAdminsEnabled != false {
		value := protoreflect.ValueOfBool(x.GlobalAdminsEnabled)
		if !f(fd_Params_global_admins_enabled, value) {
			return
		}
	}
	if x.MaxWhitelistInputArrayLength != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxWhitelistInputArrayLength)
		if !f(fd_Params_max_whitelist_input_array_length, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.v7.Params.version":
		return x.Version != ""
	case "emissions.v7.Params.max_serialized_msg_length":
		return x.MaxSerializedMsgLength != int64(0)
	case "emissions.v7.Params.min_topic_weight":
		return x.MinTopicWeight != ""
	case "emissions.v7.Params.required_minimum_stake":
		return x.RequiredMinimumStake != ""
	case "emissions.v7.Params.remove_stake_delay_window":
		return x.RemoveStakeDelayWindow != int64(0)
	case "emissions.v7.Params.min_epoch_length":
		return x.MinEpochLength != int64(0)
	case "emissions.v7.Params.beta_entropy":
		return x.BetaEntropy != ""
	case "emissions.v7.Params.learning_rate":
		return x.LearningRate != ""
	case "emissions.v7.Params.max_gradient_threshold":
		return x.MaxGradientThreshold != ""
	case "emissions.v7.Params.min_stake_fraction":
	...
	case "emissions.v7.Params.max_unfulfilled_reputer_requests":
		return x.MaxUnfulfilledReputerRequests != uint64(0)
	case "emissions.v7.Params.topic_reward_stake_importance":
	...
	case "emissions.v7.Params.topic_reward_alpha":
		return x.TopicRewardAlpha != ""
	case "emissions.v7.Params.task_reward_alpha":
	...
	case "emissions.v7.Params.max_samples_to_scale_scores":
		return x.MaxSamplesToScaleScores != uint64(0)
	case "emissions.v7.Params.max_top_inferers_to_reward":
		return x.MaxTopInferersToReward != uint64(0)
	case "emissions.v7.Params.max_top_forecasters_to_reward":
		return x.MaxTopForecastersToReward != uint64(0)
	case "emissions.v7.Params.max_top_reputers_to_reward":
		return x.MaxTopReputersToReward != uint64(0)
	case "emissions.v7.Params.create_topic_fee":
		return x.CreateTopicFee != ""
	case "emissions.v7.Params.gradient_descent_max_iters":
		return x.GradientDescentMaxIters != uint64(0)
	case "emissions.v7.Params.registration_fee":
		return x.RegistrationFee != ""
	case "emissions.v7.Params.default_page_limit":
		return x.DefaultPageLimit != uint64(0)
	case "emissions.v7.Params.max_page_limit":
		return x.MaxPageLimit != uint64(0)
	case "emissions.v7.Params.min_epoch_length_record_limit":
		return x.MinEpochLengthRecordLimit != int64(0)
	case "emissions.v7.Params.blocks_per_month":
		return x.BlocksPerMonth != uint64(0)
	case "emissions.v7.Params.p_reward_inference":
		return x.PRewardInference != ""
	case "emissions.v7.Params.p_reward_forecast":
		return x.PRewardForecast != ""
	case "emissions.v7.Params.p_reward_reputer":
		return x.PRewardReputer != ""
	case "emissions.v7.Params.c_reward_inference":
		return x.CRewardInference != ""
	case "emissions.v7.Params.c_reward_forecast":
		return x.CRewardForecast != ""
	case "emissions.v7.Params.c_norm":
		return x.CNorm != ""
	case "emissions.v7.Params.epsilon_reputer":
		return x.EpsilonReputer != ""
	case "emissions.v7.Params.half_max_process_stake_removals_end_block":
		return x.HalfMaxProcessStakeRemovalsEndBlock != uint64(0)
	case "emissions.v7.Params.epsilon_safe_div":
		return x.EpsilonSafeDiv != ""
	case "emissions.v7.Params.data_sending_fee":
		return x.DataSendingFee != ""
	case "emissions.v7.Params.max_elements_per_forecast":
		return x.MaxElementsPerForecast != uint64(0)
	case "emissions.v7.Params.max_active_topics_per_block":
		return x.MaxActiveTopicsPerBlock != uint64(0)
	case "emissions.v7.Params.max_string_length":
		return x.MaxStringLength != uint64(0)
	case "emissions.v7.Params.initial_regret_quantile":
		return x.InitialRegretQuantile != ""
	case "emissions.v7.Params.p_norm_safe_div":
		return x.PNormSafeDiv != ""
	case "emissions.v7.Params.global_whitelist_enabled":
		return x.GlobalWhitelistEnabled != false
	case "emissions.v7.Params.topic_creator_whitelist_enabled":
		return x.TopicCreatorWhitelistEnabled != false
	case "emissions.v7.Params.min_experienced_worker_regrets":
...
<<<<<<< HEAD
	case "emissions.v7.Params.lambda_initial_score":
		return x.LambdaInitialScore != ""
=======
	case "emissions.v7.Params.sortition_lambda_penalty":
		return x.SortitionLambdaPenalty != ""
	case "emissions.v7.Params.global_worker_whitelist_enabled":
		return x.GlobalWorkerWhitelistEnabled != false
	case "emissions.v7.Params.global_reputer_whitelist_enabled":
		return x.GlobalReputerWhitelistEnabled != false
	case "emissions.v7.Params.global_admins_enabled":
		return x.GlobalAdminsEnabled != false
	case "emissions.v7.Params.max_whitelist_input_array_length":
...
>>>>>>> 53d9684b (add global params)
	default:
		...
		panic(fmt.Errorf("message emissions.v7.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "emissions.v7.Params.max_string_length":
		x.MaxStringLength = uint64(0)
	case "emissions.v7.Params.initial_regret_quantile":
		x.InitialRegretQuantile = ""
	case "emissions.v7.Params.p_norm_safe_div":
		x.PNormSafeDiv = ""
	case "emissions.v7.Params.global_whitelist_enabled":
...
<<<<<<< HEAD
	case "emissions.v7.Params.lambda_initial_score":
		x.LambdaInitialScore = ""
=======
	case "emissions.v7.Params.sortition_lambda_penalty":
		x.SortitionLambdaPenalty = ""
	case "emissions.v7.Params.global_worker_whitelist_enabled":
		x.GlobalWorkerWhitelistEnabled = false
	case "emissions.v7.Params.global_reputer_whitelist_enabled":
		x.GlobalReputerWhitelistEnabled = false
	case "emissions.v7.Params.global_admins_enabled":
		x.GlobalAdminsEnabled = false
	case "emissions.v7.Params.max_whitelist_input_array_length":
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v7.Params.max_active_topics_per_block":
		...
		return protoreflect.ValueOfUint64(value)
	case "emissions.v7.Params.max_string_length":
		value := x.MaxStringLength
		return protoreflect.ValueOfUint64(value)
	case "emissions.v7.Params.initial_regret_quantile":
		value := x.InitialRegretQuantile
		return protoreflect.ValueOfString(value)
	case "emissions.v7.Params.p_norm_safe_div":
		value := x.PNormSafeDiv
		return protoreflect.ValueOfString(value)
	case "emissions.v7.Params.global_whitelist_enabled":
		value := x.GlobalWhitelistEnabled
		return protoreflect.ValueOfBool(value)
	case "emissions.v7.Params.topic_creator_whitelist_enabled":
		value := x.TopicCreatorWhitelistEnabled
		return protoreflect.ValueOfBool(value)
	case "emissions.v7.Params.min_experienced_worker_regrets":
	...
	case "emissions.v7.Params.inference_outlier_detection_alpha":
		...
		return protoreflect.ValueOfString(value)
	case "emissions.v7.Params.lambda_initial_score":
		value := x.LambdaInitialScore
		return protoreflect.ValueOfString(value)
	case "emissions.v7.Params.global_worker_whitelist_enabled":
		value := x.GlobalWorkerWhitelistEnabled
		return protoreflect.ValueOfBool(value)
	case "emissions.v7.Params.global_reputer_whitelist_enabled":
		value := x.GlobalReputerWhitelistEnabled
		return protoreflect.ValueOfBool(value)
	case "emissions.v7.Params.global_admins_enabled":
		value := x.GlobalAdminsEnabled
		return protoreflect.ValueOfBool(value)
	case "emissions.v7.Params.max_whitelist_input_array_length":
		value := x.MaxWhitelistInputArrayLength
		return protoreflect.ValueOfUint64(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v7.Params"))
		}
		panic(fmt.Errorf("message emissions.v7.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "emissions.v7.Params.max_string_length":
		x.MaxStringLength = value.Uint()
	case "emissions.v7.Params.initial_regret_quantile":
		x.InitialRegretQuantile = value.Interface().(string)
	case "emissions.v7.Params.p_norm_safe_div":
		x.PNormSafeDiv = value.Interface().(string)
	case "emissions.v7.Params.global_whitelist_enabled":
		x.GlobalWhitelistEnabled = value.Bool()
	case "emissions.v7.Params.topic_creator_whitelist_enabled":
...
<<<<<<< HEAD
	case "emissions.v7.Params.lambda_initial_score":
		x.LambdaInitialScore = value.Interface().(string)
=======
	case "emissions.v7.Params.sortition_lambda_penalty":
		x.SortitionLambdaPenalty = value.Interface().(string)
	case "emissions.v7.Params.global_worker_whitelist_enabled":
		x.GlobalWorkerWhitelistEnabled = value.Bool()
	case "emissions.v7.Params.global_reputer_whitelist_enabled":
		x.GlobalReputerWhitelistEnabled = value.Bool()
	case "emissions.v7.Params.global_admins_enabled":
		x.GlobalAdminsEnabled = value.Bool()
	case "emissions.v7.Params.max_whitelist_input_array_length":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.v7.Params.version":
		panic(fmt.Errorf("field version of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_serialized_msg_length":
		panic(fmt.Errorf("field max_serialized_msg_length of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.min_topic_weight":
		panic(fmt.Errorf("field min_topic_weight of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.required_minimum_stake":
		panic(fmt.Errorf("field required_minimum_stake of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.remove_stake_delay_window":
		panic(fmt.Errorf("field remove_stake_delay_window of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.min_epoch_length":
		panic(fmt.Errorf("field min_epoch_length of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.beta_entropy":
		panic(fmt.Errorf("field beta_entropy of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.learning_rate":
		panic(fmt.Errorf("field learning_rate of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_gradient_threshold":
		panic(fmt.Errorf("field max_gradient_threshold of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.min_stake_fraction":
		panic(fmt.Errorf("field min_stake_fraction of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_unfulfilled_worker_requests":
		panic(fmt.Errorf("field max_unfulfilled_worker_requests of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_unfulfilled_reputer_requests":
		panic(fmt.Errorf("field max_unfulfilled_reputer_requests of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.topic_reward_stake_importance":
		panic(fmt.Errorf("field topic_reward_stake_importance of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.topic_reward_fee_revenue_importance":
		panic(fmt.Errorf("field topic_reward_fee_revenue_importance of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.topic_reward_alpha":
		panic(fmt.Errorf("field topic_reward_alpha of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.task_reward_alpha":
		panic(fmt.Errorf("field task_reward_alpha of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.validators_vs_allora_percent_reward":
		panic(fmt.Errorf("field validators_vs_allora_percent_reward of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_samples_to_scale_scores":
		panic(fmt.Errorf("field max_samples_to_scale_scores of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_top_inferers_to_reward":
		panic(fmt.Errorf("field max_top_inferers_to_reward of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_top_forecasters_to_reward":
		panic(fmt.Errorf("field max_top_forecasters_to_reward of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_top_reputers_to_reward":
		panic(fmt.Errorf("field max_top_reputers_to_reward of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.create_topic_fee":
		panic(fmt.Errorf("field create_topic_fee of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.gradient_descent_max_iters":
		panic(fmt.Errorf("field gradient_descent_max_iters of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.registration_fee":
		panic(fmt.Errorf("field registration_fee of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.default_page_limit":
		panic(fmt.Errorf("field default_page_limit of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_page_limit":
		panic(fmt.Errorf("field max_page_limit of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.min_epoch_length_record_limit":
		panic(fmt.Errorf("field min_epoch_length_record_limit of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.blocks_per_month":
		panic(fmt.Errorf("field blocks_per_month of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.p_reward_inference":
		panic(fmt.Errorf("field p_reward_inference of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.p_reward_forecast":
		panic(fmt.Errorf("field p_reward_forecast of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.p_reward_reputer":
		panic(fmt.Errorf("field p_reward_reputer of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.c_reward_inference":
		panic(fmt.Errorf("field c_reward_inference of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.c_reward_forecast":
		panic(fmt.Errorf("field c_reward_forecast of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.c_norm":
		panic(fmt.Errorf("field c_norm of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.epsilon_reputer":
		panic(fmt.Errorf("field epsilon_reputer of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.half_max_process_stake_removals_end_block":
		panic(fmt.Errorf("field half_max_process_stake_removals_end_block of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.epsilon_safe_div":
		panic(fmt.Errorf("field epsilon_safe_div of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.data_sending_fee":
		panic(fmt.Errorf("field data_sending_fee of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_elements_per_forecast":
		panic(fmt.Errorf("field max_elements_per_forecast of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_active_topics_per_block":
		panic(fmt.Errorf("field max_active_topics_per_block of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_string_length":
		panic(fmt.Errorf("field max_string_length of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.initial_regret_quantile":
		panic(fmt.Errorf("field initial_regret_quantile of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.p_norm_safe_div":
		panic(fmt.Errorf("field p_norm_safe_div of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.global_whitelist_enabled":
		panic(fmt.Errorf("field global_whitelist_enabled of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.topic_creator_whitelist_enabled":
		panic(fmt.Errorf("field topic_creator_whitelist_enabled of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.min_experienced_worker_regrets":
		panic(fmt.Errorf("field min_experienced_worker_regrets of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.inference_outlier_detection_threshold":
...
<<<<<<< HEAD
	case "emissions.v7.Params.lambda_initial_score":
		panic(fmt.Errorf("field lambda_initial_score of message emissions.v7.Params is not mutable"))
=======
	case "emissions.v7.Params.sortition_lambda_penalty":
		panic(fmt.Errorf("field sortition_lambda_penalty of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.global_worker_whitelist_enabled":
		panic(fmt.Errorf("field global_worker_whitelist_enabled of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.global_reputer_whitelist_enabled":
		panic(fmt.Errorf("field global_reputer_whitelist_enabled of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.global_admins_enabled":
		panic(fmt.Errorf("field global_admins_enabled of message emissions.v7.Params is not mutable"))
	case "emissions.v7.Params.max_whitelist_input_array_length":
		panic(fmt.Errorf("field max_whitelist_input_array_length of message emissions.v7.Params is not mutable"))
>>>>>>> 53d9684b (add global params)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v7.Params"))
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.v7.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.MaxStringLength != 0 {
			n += 2 + runtime.Sov(uint64(x.MaxStringLength))
		}
		l = len(x.InitialRegretQuantile)
		if l > 0 {
			n += 2 + l + runtime.Sov(uint64(l))
		}
		l = len(x.PNormSafeDiv)
		if l > 0 {
			n += 2 + l + runtime.Sov(uint64(l))
		}
		if x.GlobalWhitelistEnabled {
			n += 3
		}
		if x.TopicCreatorWhitelistEnabled {
			n += 3
		}
		if x.MinExperiencedWorkerRegrets != 0 {
			n += 2 + runtime.Sov(uint64(x.MinExperiencedWorkerRegrets))
		}
		l = len(x.InferenceOutlierDetectionThreshold)
		if l > 0 {
			n += 2 + l + runtime.Sov(uint64(l))
		}
		l = len(x.InferenceOutlierDetectionAlpha)
		if l > 0 {
			n += 2 + l + runtime.Sov(uint64(l))
		}
		l = len(x.LambdaInitialScore)
		if l > 0 {
			n += 2 + l + runtime.Sov(uint64(l))
		}
		if x.GlobalWorkerWhitelistEnabled {
			n += 3
		}
		if x.GlobalReputerWhitelistEnabled {
			n += 3
		}
		if x.GlobalAdminsEnabled {
			n += 3
		}
		if x.MaxWhitelistInputArrayLength != 0 {
			n += 2 + runtime.Sov(uint64(x.MaxWhitelistInputArrayLength))
		}
...
<<<<<<< HEAD
		if len(x.LambdaInitialScore) > 0 {
			i -= len(x.LambdaInitialScore)
			copy(dAtA[i:], x.LambdaInitialScore)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.LambdaInitialScore)))
=======
		if x.MaxWhitelistInputArrayLength != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxWhitelistInputArrayLength))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xd8
		...
		if len(x.SortitionLambdaPenalty) > 0 {
			i -= len(x.SortitionLambdaPenalty)
			copy(dAtA[i:], x.SortitionLambdaPenalty)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.SortitionLambdaPenalty)))
>>>>>>> 53d9684b (add global params)
			i--
			dAtA[i] = 0x3
			i--
		...
		if len(x.InferenceOutlierDetectionAlpha) > 0 {
			...
			copy(dAtA[i:], x.InferenceOutlierDetectionAlpha)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.InferenceOutlierDetectionAlpha)))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xb2
		...
		if len(x.InferenceOutlierDetectionThreshold) > 0 {
			i -= len(x.InferenceOutlierDetectionThreshold)
			copy(dAtA[i:], x.InferenceOutlierDetectionThreshold)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.InferenceOutlierDetectionThreshold)))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xaa
		...
		if x.MinExperiencedWorkerRegrets != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MinExperiencedWorkerRegrets))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xa0
		...
		if len(x.PNormSafeDiv) > 0 {
			i -= len(x.PNormSafeDiv)
			copy(dAtA[i:], x.PNormSafeDiv)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.PNormSafeDiv)))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0x8a
		...
		if len(x.InitialRegretQuantile) > 0 {
			i -= len(x.InitialRegretQuantile)
			copy(dAtA[i:], x.InitialRegretQuantile)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.InitialRegretQuantile)))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0x82
		...
		if x.MaxStringLength != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxStringLength))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xf8
		...
		for iNdEx < l {
			...
			case 47:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxStringLength |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 48:
				...
				x.InitialRegretQuantile = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 49:
				if wireType != 2 {
				...
				x.PNormSafeDiv = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 50:
				if wireType != 0 {
				...
				x.GlobalWhitelistEnabled = bool(v != 0)
			case 51:
				if wireType != 0 {
				...
				x.TopicCreatorWhitelistEnabled = bool(v != 0)
			case 52:
				if wireType != 0 {
				...
				x.MinExperiencedWorkerRegrets = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
			...
			case 53:
				...
				x.InferenceOutlierDetectionThreshold = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 54:
				if wireType != 2 {
			...
			case 55:
				...
				x.LambdaInitialScore = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 56:
				if wireType != 0 {
				...
				x.GlobalWorkerWhitelistEnabled = bool(v != 0)
			case 57:
				if wireType != 0 {
				...
				x.GlobalReputerWhitelistEnabled = bool(v != 0)
			case 58:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field GlobalAdminsEnabled", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.GlobalAdminsEnabled = bool(v != 0)
			case 59:
				if wireType != 0 {
				...
				x.MaxWhitelistInputArrayLength = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxWhitelistInputArrayLength |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type Params struct {
	...
	InitialRegretQuantile   string `protobuf:"bytes,48,opt,name=initial_regret_quantile,json=initialRegretQuantile,proto3" json:"initial_regret_quantile,omitempty"`
...
<<<<<<< HEAD
	LambdaInitialScore                 string `protobuf:"bytes,55,opt,name=lambda_initial_score,json=lambdaInitialScore,proto3" json:"lambda_initial_score,omitempty"`
=======
	// Constant used to determine the penalty for non-live actors
	SortitionLambdaPenalty        string `protobuf:"bytes,55,opt,name=sortition_lambda_penalty,json=sortitionLambdaPenalty,proto3" json:"sortition_lambda_penalty,omitempty"`
	...
	GlobalAdminsEnabled           bool   `protobuf:"varint,58,opt,name=global_admins_enabled,json=globalAdminsEnabled,proto3" json:"global_admins_enabled,omitempty"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_emissions_v7_params_proto_rawDescGZIP(), []int{0}
}
...
func (x *Params) GetInferenceOutlierDetectionThreshold() string {
	if x != nil {
		return x.InferenceOutlierDetectionThreshold
	}
	return ""
...
func (x *Params) GetInferenceOutlierDetectionAlpha() string {
	if x != nil {
		return x.InferenceOutlierDetectionAlpha
	}
	return ""
...
func (x *Params) GetLambdaInitialScore() string {
	if x != nil {
		return x.LambdaInitialScore
	}
	return ""
...
func (x *Params) GetGlobalWorkerWhitelistEnabled() bool {
	if x != nil {
...
func (x *Params) GetGlobalReputerWhitelistEnabled() bool {
	if x != nil {
...
func (x *Params) GetGlobalAdminsEnabled() bool {
	if x != nil {
		return x.GlobalAdminsEnabled
	}
	return false
}

func (x *Params) GetMaxWhitelistInputArrayLength() uint64 {
	if x != nil {
...
var file_emissions_v7_params_proto_rawDesc = []byte{
	0x0a, 0x19, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x76, 0x37, 0x2f, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x65, 0x6d, 0x69,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x37, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e, 0x6f,
...
<<<<<<< HEAD
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x21,
=======
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa8, 0x24,
>>>>>>> 53d9684b (add global params)
	...
	,
	...
	0x0c, 0x70, 0x4e, 0x6f, 0x72, 0x6d, 0x53, 0x61, 0x66, 0x65, 0x44, 0x69, 0x76, 0x12, 0x3f, 0x0a,
	0x18, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x5f, 0x77, 0x68, 0x69, 0x74, 0x65, 0x6c, 0x69, 0x73,
<<<<<<< HEAD
	0x74, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x32, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x16, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x57, 0x68, 0x69, 0x74, 0x65, 0x6c, 0x69, 0x73, 0x74,
	0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x45, 0x0a, 0x1f, 0x74, 0x6f, 0x70, 0x69, 0x63,
	0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x77, 0x68, 0x69, 0x74, 0x65, 0x6c, 0x69,
	0x73, 0x74, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x33, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x1c, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x57, 0x68,
	...
	,
	...
	0x41, 0x6c, 0x70, 0x68, 0x61, 0x12, 0x69, 0x0a, 0x14, 0x6c, 0x61, 0x6d, 0x62, 0x64, 0x61, 0x5f,
	0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x37, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x37, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x2f, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x6c, 0x6c, 0x6f, 0x72, 0x61, 0x2d, 0x6e,
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x61, 0x6c, 0x6c, 0x6f, 0x72, 0x61, 0x2d, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x12, 0x6c, 0x61,
	0x6d, 0x62, 0x64, 0x61, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x53, 0x63, 0x6f, 0x72, 0x65,
	...
	0x6f, 0x6d, 0x2e, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x37, 0x42,
	...
	0x2f, 0x76, 0x37, 0x3b, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x76, 0x37, 0xa2,
	0x02, 0x03, 0x45, 0x58, 0x58, 0xaa, 0x02, 0x0c, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x73, 0x2e, 0x56, 0x37, 0xca, 0x02, 0x0c, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73,
	0x5c, 0x56, 0x37, 0xe2, 0x02, 0x18, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x5c,
	0x56, 0x37, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02,
	0x0d, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x3a, 0x3a, 0x56, 0x37, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
=======
	,
	...
	0x6e, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x22, 0x69, 0x6e, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x4f, 0x75, 0x74, 0x6c, 0x69, 0x65, 0x72, 0x44, 0x65, 0x74, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x12, 0x82,
	0x01, 0x0a, 0x21, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x6f, 0x75, 0x74,
	0x6c, 0x69, 0x65, 0x72, 0x5f, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x18, 0x36, 0x20, 0x01, 0x28, 0x09, 0x42, 0x37, 0xc8, 0xde, 0x1f, 0x00,
	...
	,
	...
	0x37, 0x3b, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x76, 0x37, 0xa2, 0x02, 0x03,
	0x45, 0x58, 0x58, 0xaa, 0x02, 0x0c, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e,
	0x56, 0x37, 0xca, 0x02, 0x0c, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x5c, 0x56,
	0x37, 0xe2, 0x02, 0x18, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x5c, 0x56, 0x37,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0d, 0x45,
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x3a, 0x3a, 0x56, 0x37, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
>>>>>>> 53d9684b (add global params)
}

var (
	file_emissions_v7_params_proto_rawDescOnce sync.Once
	file_emissions_v7_params_proto_rawDescData = file_emissions_v7_params_proto_rawDesc
)

func file_emissions_v7_params_proto_rawDescGZIP() []byte {
	file_emissions_v7_params_proto_rawDescOnce.Do(func() {
		file_emissions_v7_params_proto_rawDescData = protoimpl.X.CompressGZIP(file_emissions_v7_params_proto_rawDescData)
	})
	return file_emissions_v7_params_proto_rawDescData
}

var file_emissions_v7_params_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_emissions_v7_params_proto_goTypes = []interface{}{
	(*Params)(nil), // 0: emissions.v7.Params
}
var file_emissions_v7_params_proto_depIdxs = []int32{
...
func init() { file_emissions_v7_params_proto_init() }
func file_emissions_v7_params_proto_init() {
	if File_emissions_v7_params_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_emissions_v7_params_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_emissions_v7_params_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_emissions_v7_params_proto_goTypes,
		DependencyIndexes: file_emissions_v7_params_proto_depIdxs,
		MessageInfos:      file_emissions_v7_params_proto_msgTypes,
	}.Build()
	File_emissions_v7_params_proto = out.File
	file_emissions_v7_params_proto_rawDesc = nil
	file_emissions_v7_params_proto_goTypes = nil
	file_emissions_v7_params_proto_depIdxs = nil
}
